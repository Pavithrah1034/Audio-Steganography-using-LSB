...
from AudioSteganographyAlgo.LSB import LSBAudioStego
...
class Window(Frame):
    ...
    def Enocoding(self):
        ...
        self.encodelabel = Label(root, textvariable=self.encodeVar, font=('bold', 26))
    ...
    def Decoding(self):
        ...
        self.decodelabel = Label(root, textvariable=self.decodeVar, font=('bold', 26))
